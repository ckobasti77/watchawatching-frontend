    ...
    <div className="movies-wrapper">
      <div className="container-fluid">
          ...
          {trending?.map((single) => {
            return (
              <SingleCard
                ...
                release_date={single.release_date ? single.release_date.slice(0, 4) : single.first_air_date.slice(0, 4)}
        ...
        {openModal &&
          modal.map((one) => {
            return (
              <div className="modal-container" onClick={changeModal} style={{zIndex: 9999}}>
                <div
