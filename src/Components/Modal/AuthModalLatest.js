...
const AuthModalLatest = (props) => {
  return (
    <div
      className="modal-container"
      onClick={props.changeModal}
      style={{ zIndex: 1234567, transform: "scale(1)" }}
    >
      <div
        ...
        <div className="modal-content row">
          <div className="modal-left col-xs-12 col-lg-8">
            <iframe
              ...
              width="840"
              height="450"
              src={`https://www.youtube.com/embed/${props.video}?rel=0&autoplay=1&allowfullscreen`}
              frameborder="0"
          ...
          <div className="modal-right col-xs-12 col-lg-4 ">
            ...
            <div className="genres-vote d-flex justify-content-between align-items-end">
              ...
              >
                ...
                >
                  save to <br />
                  <span style={{ color: "#a83f39", display: "inline-block", textDecoration: "underline" }}>
                    favorites
                  </span>
                </span>
            ...
            <div className="watch-links">
              <a
                href={`https://gledalica.online/movies/${
                  props.title ? props.title.split(' ').join('-') : props.name.split(' ').join('-')
                }/`}
...
export default AuthModalLatest;
